function MapsInteractive() {
    return (
      <div className="flex justify-center items-center  bg-gradient-to-b from-gray-400 to-gray-600 h-screen mt-0">
        <div>
          <iframe
            title="Google Maps"
            ...
            width="1450"
            height="700"
            className="m-4 sm:w-[650px] sm:h-[500px] md:w-[1450px] md:h-[700px]"
            style={{ border: 0 }}
            allowFullScreen=""
            loading="lazy"
